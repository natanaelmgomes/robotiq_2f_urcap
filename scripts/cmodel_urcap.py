...
class RobotiqCModelURCap:
    ...
    def prepare_to_grasp(self):
        """
        Prepare the gripper to perform a grasping attempt
        input:
            none
        output:
            none
        ...
        # pos: 0 = open ## speed: 255 = max_speed ## force: 255 = max_force #
        result = gripper.move_and_wait_for_pos(0, 255, 255)

        # object detection (0 = moving, 1 = outer grip, 2 = inner grip, 3 = no object at rest)
        if result[1] == RobotiqCModelURCap.ObjectStatus.AT_DEST:
            # print('gripper open and ready')
            return True
        else:
            return False
    def try_to_grasp(self):
        """
        Perform an attempt to grasp and return the result
        input:
            none
        output:
            bool:
                True: grasp successful
                False: grasp fail
        """
        # pos: 255 = close ## speed: 255 = max_speed ## force: 255 = max_force #
        result = gripper.move_and_wait_for_pos(255, 255, 255)

        # object detection (0 = moving, 1 = outer grip, 2 = inner grip, 3 = no object at rest)
        if result[1] == RobotiqCModelURCap.ObjectStatus.STOPPED_INNER_OBJECT:
...
if __name__ == '__main__':
    ...
    # gripper.connect('192.168.56.2', 63352)
    gripper.activate()
    # result = gripper.move_and_wait_for_pos(0, 255, 255)
    # print(result)
    # result = gripper.move_and_wait_for_pos(100, 255, 255)
    # print(result)
    # result = gripper.move_and_wait_for_pos(0, 255, 255)
    # print(result)
    # result = gripper.move_and_wait_for_pos(200, 255, 255)
    # print(result)
    # result = gripper.move_and_wait_for_pos(0, 255, 255)
    # print(result)
    # result = gripper.move_and_wait_for_pos(255, 255, 255)
    # print(result)
    print('')
    print('Prepare to grasp')
    result = gripper.prepare_to_grasp()
    print(result)
    # move to position
    print('')
    print('Try to grasp')
    result = gripper.try_to_grasp()
    print(result)